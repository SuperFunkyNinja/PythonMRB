...
EXCEL = Path(
    r"C:\EPDMVault\Projects\Current\016867s L&T Hydrocarbon Saudi\04 - Final Manual Books\MRB Books\016867 - Baseframe MRB index.xlsx"
)
...
C_RED = (1, 0, 0)
C_BLACK = (0, 0, 0)
PDF = Path("Blank PDF\\" + sheet["B6"].value + ".pdf")
